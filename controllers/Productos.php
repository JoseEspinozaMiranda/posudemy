...
class Productos extends Controller
{
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            $data[$i]['imagen'] = '<img class="img-thumbnail" src="' . BASE_URL . $foto . '" alt="" width="50">';
            ...
            if (empty($codigo)) {
                ...
                if ($id == '') {
                    ...
                    if (empty($verificar)) {
                        ...
                        $data = $this->model->registrar($codigo, $nombre, $precio_compra, $precio_venta, $id_medida, $id_categoria, $destino);
                        if ($data > 0) {
                            if (!empty($name)) {
                    ...
                    if (empty($verificar)) {
                        ...
                        $data = $this->model->actualizar($codigo, $nombre, $precio_compra, $precio_venta, $id_medida, $id_categoria, $destino, $id);
                        if ($data > 0) {
    ...
    public function listarInactivos()
    {
       ...
       $data = $this->model->getProductos(0);
        for ($i = 0; $i < count($data); $i++) {
            $data[$i]['imagen'] = '<img class="img-thumbnail" src="' . BASE_URL . $data[$i]['foto'] . '" alt="" width="100">';
