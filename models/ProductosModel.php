...
class ProductosModel extends Query{
    ...
    public function registrar($codigo, $nombre, $precio_compra, $precio_venta, $id_medida, $id_categoria, $foto)
    {
        $sql = "INSERT INTO productos (codigo, descripcion, precio_compra, precio_venta, id_medida, id_categoria, foto) VALUES (?,?,?,?,?,?,?)";
        $array = array($codigo, $nombre, $precio_compra, $precio_venta, $id_medida, $id_categoria, $foto);
    ...
    {
        $sql = "SELECT id, descripcion, cantidad FROM productos WHERE codigo = '$valor' AND estado = 1";
        return $this->select($sql);
    }
