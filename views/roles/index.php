...
<div class="card">
    <div class="card-body">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-3" id="nav-roles" role="tabpanel" aria-labelledby="nav-roles-tab" tabindex="0">
            ...
            <div class="tab-pane fade p-3" id="nav-nuevo" role="tabpanel" aria-labelledby="nav-nuevo-tab" tabindex="0">
                <form id="formulario" autocomplete="off">
                    ...
                    <div class="row mb-3">
                        ...
                        <label for="nombre_corto">Permisos <span class="text-danger">*</span></label>
                        <hr>
                        ...
                        <div class="col-md-4">
                            <div class="btn-group-toggle mb-1" data-toggle="buttons">
                                <label class="btn btn-outline-primary">
                                    <input type="checkbox" class="listaPermisos" name="permisos[]" value="<?php echo $permiso['nombre']; ?>"> <?php echo $permiso['nombre']; ?>
                                </label>
                            </div>  
                        </div>
                        <?php } ?>  
